          ...
          <div className="space-y-1">
            ...
            <div className="relative z-10 -my-5 flex justify-center">
              <Button
                ...
                variant="outline"
                size="icon"
                className="size-9 rounded-full border-4 border-background bg-card backdrop-blur-sm shadow-sm"
                ...
                >
                  {SORT_TABS.map((tab) => (
                    <button
                      ...
                      className={
                        sort === tab.value
                          ? "flex-1 rounded-full bg-card backdrop-blur-sm px-2 py-1 font-semibold text-foreground shadow-sm"
