    ...
    <PageContainer>
      <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
        ...
        <div>
          ...
          <dl className="mt-6 grid grid-cols-2 gap-4 rounded-xl border border-border bg-card backdrop-blur-md p-5 sm:grid-cols-4">
            <div>
          ...
          <section className="mt-4 rounded-xl border border-border bg-card backdrop-blur-md p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              ...
              {agent.pulsePerDay} $ORCA per day, starting from its activation timestamp. Accumulated
              allocation remains locked until the official Token Generation Event and claim
              activation — minting is not currently live.
            </p>
          </section>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {related.map((other) => (
              <Link
                ...
                className="rounded-xl border border-border bg-card backdrop-blur-md p-3 text-center transition-colors hover:border-primary/40"
              >
                <AgentPortrait
